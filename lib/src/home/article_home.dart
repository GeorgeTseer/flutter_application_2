...
class HomeArticleOne extends StatelessWidget {
  const HomeArticleOne({Key? key}) : super(key: key);
  static const routeName = '/article1';
  final index = 1;
  @override
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _ListOfArticles(articles: Article.articles),
        ],
      ),
    );
  }
