...
class HomeArticleTwo extends StatelessWidget {
  const HomeArticleTwo({Key? key}) : super(key: key);
  static const routeName = '/article2';
  final index = 1;
  @override
  Widget build(BuildContext context) {
    Article article = Article.articles2[0];
    return Scaffold(
      appBar: AppBar(),
      ...
      body: ListView(
        children: [
          ...
          _ListOfArticles(articles: Article.articles2),
        ],
      ),
    );
  }
